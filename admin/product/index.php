...
<table border="1">
    ...
    <?php
        ...
        while ($row = mysqli_fetch_array($result)) {// для каждой строки из запроса
            ...
            echo "</td>";
            echo "<td><a href='edit.php?id=" . $row['product_code_ID'] . "' class='edit'>Edit</a></td>"; // запуск скрипта для редактирования
            echo "<td><a href='delete.php?id=" . $row['product_code_ID'] . "' class='delete'>Delete</a></td>"; // запуск скрипта для удаления записи
            echo "</tr>";
        }
        echo "</table>";
        $num_rows = mysqli_num_rows($result); // число записей в таблице БД
        print("<P>Total number of products: $num_rows </p>");
    ?>
