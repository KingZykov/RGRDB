...
<table border="1">
    ...
    <?php
        ...
        while ($row = mysqli_fetch_array($result)) {// для каждой строки из запроса
            ...
            echo "</td>";
            echo "<td><a href='edit.php?id=" . $row['receipt_invoice_number'] . "' class='edit'>Добавить</a></td>"; // запуск скрипта для редактирования
            echo "<td><a href='delete.php?id=" . $row['receipt_invoice_number'] . "' class='delete'>Удалить</a></td>"; // запуск скрипта для удаления записи
            echo "</tr>";
        }
        echo "</table>";
